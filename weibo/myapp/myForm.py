...
from wtforms import StringField,validators,PasswordField,SubmitField,TextAreaField,FileField
...
class LoginForm(FlaskForm):
    name = StringField("Name:",
                       validators=[validators.DataRequired("Enter your name"),
                                   validators.Regexp(ur'^[a-zA-Z0-9\u4e00-\u9fa5]+$',message='invalid input.')],
                       render_kw={'placeholder':'name'}

    )
    passwd=PasswordField("Password:",validators=[validators.required("Enter your password")],render_kw={'placeholder':'Email'})
...
class ResgiterForm(FlaskForm):
    name=StringField('name',
                     validators=[
                                ...
                                validators.Regexp(ur'([a-zA-Z\u4e00-\u9fa5])([a-zA-Z0-9\u4e00-\u9fa5]+$)',message=\
