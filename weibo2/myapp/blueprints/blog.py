#coding:utf8
from flask import redirect,url_for,render_template,request,flash,abort,current_app,session
...
def delete_post(loc,post_id):
    ...
    return redirect(url_for('blog.{}'.format(loc)))
